//
//  MatchResultTeamListViewController.swift
//  TodayBasket
//
...
class MatchResultTeamListViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
                    ...
                    if((responseData.result.value) != nil) {
                        ...
                        if self.arrRes.count > 0 {
                            ...
                            if(self.teamPk == ".") {
                                ...
                                Alamofire.request("http://210.122.7.193:8080/TodayBasket_IOS/MatchResultTeam.jsp?Data1=\(self.teamPk)").responseJSON { (responseData) -> Void in
                                    if((responseData.result.value) != nil) {
                                        let swiftyJsonVar = JSON(responseData.result.value!)
