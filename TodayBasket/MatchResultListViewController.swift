//
//  MatchResultListViewController.swift
//  TodayBasket
//
//  Created by ldong on 2017. 6. 26..
...
class MatchResultListViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func getMatchResults() {
        ...
        Alamofire.request("http://210.122.7.193:8080/TodayBasket_IOS/MatchResult.jsp").responseJSON { (responseData) -> Void in
    ...
    func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        ...
        if indexPath.row == lastCell {
            ...
            if(isScrollFinished == false) {
                ...
                Alamofire.request("http://210.122.7.193:8080/TodayBasket_IOS/MatchResultMore.jsp?Data1=\(lastMatchResultPk)").responseJSON { (responseData) -> Void in
                    if((responseData.result.value) != nil) {
                        let swiftyJsonVar = JSON(responseData.result.value!)
